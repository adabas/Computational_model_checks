...
%
% At a trial, the agent sticks with the option that previously resulted in a
...
%       rprob   :   reward probabilities for each stimulus as a 1X2 vector
%
% OUTPUT:
